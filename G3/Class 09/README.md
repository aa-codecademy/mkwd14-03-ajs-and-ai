...
**Important note**: This API requires a key to work. You can get a key by signing up at [OpenWeatherMap](https://home.openweathermap.org/users/sign_up). It can take up to 2 hours for the key to arrive at email, so please be aware and plan ahead.
