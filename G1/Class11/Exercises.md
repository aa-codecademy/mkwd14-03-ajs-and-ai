...
You are encouraged to use AI tools (like ChatGPT or GitHub Copilot) to help you write the classes, functions, and methods. Use AI as a learning assistant, not to copy everything blindly. You can ask for hints, examples, or code templates and then implement the logic yourself. Make sure to test your code in the browser console or VS Code to understand how objects interact dynamically.
